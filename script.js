...
['💡','NOSSA PROPOSTA','Recursos abertos e colaborativos.', '<p>A proposta principal do projeto é criar recursos digitais abertos e colaborativos para qualificar o conhecimento público sobre o idioma e reduzir estigmas. Ele se desenvolve em três etapas integradas:</p><ol class="custom-list"><li>Revisão de terminologia</li><li>Intervenção em espaços digitais de grande consulta, como a Wikipédia</li><li>Desenvolvimento de uma ferramenta online de conversão entre normas.</li></ol>'],
['🎯','NOSSO OBJETIVO','Transformação social e direitos linguísticos.', '<p>O objetivo final é contribuir, a médio e longo prazo, para uma transformação social voltada aos direitos linguísticos, melhorando a qualidade do que se lê sobre o português na internet. O projeto busca diminuir preconceitos sobre as diferentes formas de falar, apoiar práticas mais justas na educação e consolidar referências gratuitas e duradouras sobre a variação da nossa língua no meio digital.</p>']
];
